...
<?php 
	...
	$html .= "<tr>";
		...
		$html .= "<th><a href='?q=".$q."&sort=id&order=".$idOrder."'>id</a></th>";
	...
	foreach($carData as $c){
		...
		$html .= "<tr>";
            ...
            $html .= "<td><a class='btn btn-default btn-sm' href='edit.php?id=".$c->id."'><span class'glyphicon-pencil'></span>Muuda</a></td>";
